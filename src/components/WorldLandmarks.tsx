    ...
    <div className="absolute inset-0 pointer-events-none" style={{ width: '19000px', height: '100%' }}>
      ...
      >
        <div className="bg-white/95 backdrop-blur-md border border-neutral-300 px-4 py-2 rounded-full text-xs font-mono tracking-widest text-neutral-700 shadow-sm flex items-center gap-2 mb-3 group-hover:scale-105 group-hover:border-amber-400 transition-all">
          ...
          <span>ORIGIN / GIOVANNI.FJ</span>
          <span className="text-[10px] bg-amber-100 text-amber-900 px-2 py-0.5 rounded-full font-bold">Biografia</span>
        </div>
        <svg width="120" height="180" viewBox="0 0 120 180" className="group-hover:scale-105 transition-transform duration-200">
          {/* Stone Marker / Monolith */}
      ...
      {/* World 1: Fercal, DF (Origens / Natureza / Sobradinho) */}
      <div
      ...
      >
        ...
        <svg width="290" height="230" viewBox="0 0 290 230" className="overflow-visible">
          {/* Green Cerrado Hills Background */}
          <path
            d="M10 185 Q 90 120 180 160 Q 240 135 285 185 Z"
            fill="#40916c"
            opacity="0.85"
          />
          <path
            d="M50 185 Q 140 100 230 185 Z"
            fill="#52b788"
            opacity="0.6"
          />
          ...
          {/* Grassy Plinth Base for Monument */}
          ...
          {/* 3D "EU ❤️ FERCAL" Monument Structure */}
          {/* "EU" */}
          ...
          <g transform="translate(80, 133)">
            <path
              d="M12 4 C8 0, 0 2, 0 10 C0 16, 12 24, 12 24 C12 24, 24 16, 24 10 C24 2, 16 0, 12 4 Z"
              fill="#e63946"
              stroke="#b7094c"
              strokeWidth="1.2"
            />
      ...
      >
        ...
        <svg width="270" height="230" viewBox="0 0 270 230" className="overflow-visible">
          ...
          <text x="143" y="102" fill="#38bdf8" fontSize="6" fontFamily="monospace">&gt; codex agent</text>
          <text x="143" y="112" fill="#a3e635" fontSize="5" fontFamily="monospace">✓ healthy (v0.4)</text>
          <text x="143" y="120" fill="#94a3b8" fontSize="4.5" fontFamily="monospace">ollama 0.18.2</text>
      ...
      >
        ...
        <svg width="280" height="230" viewBox="0 0 280 230" className="overflow-visible">
          {/* Traditional Japanese Tea House / Rest Shelter */}
          {/* Tiled Roof */}
          <path
            d="M30 85 Q 140 50 250 85 L260 95 Q 140 70 20 95 Z"
            fill="#3a3836"
            stroke="#211f1e"
            strokeWidth="1.5"
          />
          ...
          {/* Ceramic Teacup & Shaved Ice Bowl on bench */}
      ...
      >
        ...
        <svg width="270" height="230" viewBox="0 0 270 230" className="overflow-visible">
          ...
          {/* Secondary Teal Leather Gift Box */}
      ...
      {/* Act II Entrance Celestial Gate (Threshold at 17800) */}
      <div
      ...
      >
        <div className="mb-4 transition-transform group-hover:scale-110 duration-200">
          <div className="bg-neutral-900 text-amber-200 border border-amber-400/50 px-4 py-2 rounded-full shadow-xl flex items-center gap-2.5 text-xs font-serif tracking-wider">
            ...
            <span className="font-semibold">ACT II // LIVING ATLAS</span>
            <span className="text-neutral-400 font-mono text-[10px]">ENTER ➔</span>
          </div>
        </div>

        <svg width="340" height="280" viewBox="0 0 340 280" className="overflow-visible">
          {/* Celestial Gateway Arch */}
          <path
            d="M50 210 L50 70 Q 170 15 290 70 L290 210"
            stroke="#b45309"
            strokeWidth="4"
            fill="none"
            strokeLinecap="round"
          />
          <path
            d="M65 210 L65 80 Q 170 35 275 80 L275 210"
            stroke="#f59e0b"
            strokeWidth="1.5"
            fill="none"
            strokeDasharray="4,4"
      ...
      <div className="absolute bottom-0 left-0 w-full h-[110px] bg-gradient-to-b from-[#e8e2d7] to-[#dfd7ca] border-t-2 border-[#d5cbbe]">
        ...
        {/* Milestone Stone Markers every 2000m */}
